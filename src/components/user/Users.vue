<template>
  <div>
    ...
    <!-- 添加用户对话框 -->
    <el-dialog :visible.sync="dialogVisible" title="添加用户" width="50%" @close="addDialogClosed" :close-on-click-modal="false">
      <!-- 主体内容 -->
      <span>
    ...
    <!-- 修改用户对话框 -->
    <el-dialog title="修改用户信息" :visible.sync="editDialogVisible" width="50%" @close="editDialogColosed" :close-on-click-modal="false">
      <span>
    ...
    <!-- 分配角色对话框 -->
    <el-dialog :visible.sync="setRoleDialogVisible" title="分配角色" width="50%" :close-on-click-modal="false" @close="setRoleDialogClosed">
      <!-- 主体内容 -->
      <div>
